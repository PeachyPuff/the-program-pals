...
describe('Editor', function () {
  ...
  describe('with plugins', function () {
    ...
    it.skip('returns the component reference when we call the getEditorRef inside of a plugin', function () {
  ...
  describe('decorators prop', function () {
    ...
    it.skip('uses strategies from both decorators and plugins together', function () {
    ...
    it.skip('uses components from both decorators and plugins together', function () {
    ...
    it.skip('uses both custom and simple decorators in plugins', function () {
